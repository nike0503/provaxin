...
if len(sys.argv) < 3:
    print("Syntax: python pronpm_extractor.py <outputFile> <evalFile1> [evalFile<2> ...]")

outputFile = sys.argv[1]
numEvalFiles = len(sys.argv) - 2
evalFiles = sys.argv[2:]
...
if __name__ == '__main__':
    ...
    for ffile in evalFiles:
        try:
            res = extract_infos(ffile)
            res.append(1)
